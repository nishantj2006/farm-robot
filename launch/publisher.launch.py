...
def generate_launch_description():
    # --- SETUP YAML PATHS ---
    # Change 'stereo_sync_spoofer' if your config folder is in a different package!
    pkg_dir = get_package_share_directory('stereo_sync_spoofer')
