...
: ${AMENT_CURRENT_PREFIX:="/workspaces/isaac_ros-dev/src/stereo_depth_yolo/install/stereo_depth_yolo"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/stereo_depth_yolo/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/stereo_depth_yolo/environment/path.sh"
