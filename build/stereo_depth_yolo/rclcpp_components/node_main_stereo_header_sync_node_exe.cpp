...
#define NODE_MAIN_LOGGER_NAME "stereo_header_sync_node_exe"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libstereo_header_sync_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<stereo_depth_yolo::StereoHeaderSyncNode>";
